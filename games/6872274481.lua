        ...
        Function = function(callback)
            if callback then
                repeat
                            ...
                            for _, data in getProjectiles() do
                                ...
                                if (FireDelays[item.itemType] or 0) < tick() then
                                    ...
                                    if calc then
                                        ...
                                        -- 👇 Speed.Value scales the fire delay — lower = faster
                                        FireDelays[item.itemType] = tick() + (itemMeta.fireDelaySec / Speed.Value)
                                        if switched then
                                            task.wait(0.05)
                                        end
                                    end
                    ...
                    -- 👇 loop frequency also driven by Speed — cranked up = shoots more often
